...
export default function ComingSoon({ title }) {
  return (
    <div className="page-shell">
      <Header />
      <main
        className="container page-content page-shell-main"
        style={{ paddingTop: '160px', textAlign: 'center' }}
      >
        <h1>{title}</h1>
        <p style={{ color: '#5a5f73' }}>
          This page hasn't been migrated to the new React frontend yet.
        </p>
        <Link
          to="/"
