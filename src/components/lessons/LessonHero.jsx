          ...
          <div className="col-lg-7 fade-in">
            ...
            <div className="hero-actions">
              ...
              <button
                ...
                onClick={() =>
                  document
                    .querySelector('.page-content section.content-card')
          ...
          <div className="col-lg-5 fade-in">
            <div className="hero-illustration">
              ...
              <svg
                ...
                role="img"
                aria-label="Illustration of a student coding on a laptop"
              >
                <ellipse cx="180" cy="270" rx="140" ry="16" fill="#dfeaff" />
                <rect x="18" y="200" width="34" height="46" rx="6" fill="#c9d8ef" />
                <path
                  d="M35 200 C 10 170, 10 140, 35 120 C 60 140, 60 170, 35 200 Z"
                  fill="#79c58f"
                />
                <path
                  d="M35 200 C 55 180, 55 150, 35 130"
                  stroke="#5aa876"
                  strokeWidth="3"
                  fill="none"
                />
